package pneum4.board.comment.api;
...
public class CommentApiTest {
    ...
    void create() {
        ...
        System.out.println("commentId=$s" + res1.getCommentId());
        System.out.println("\tcommentId=$s" + res2.getCommentId());
        System.out.println("\tcommentId=$s" + res3.getCommentId());
    }
    ...
    void read() {
        CommentResponse res = restClient.get()
                .uri("/v1/comments/{commendId}", 217913683360153600L)
                .retrieve()
                .body(CommentResponse.class);
    ...
    void delete() {
        restClient.delete()
                .uri("/v1/comments/{commentId}", 217913684081573888L)
                .retrieve();
    }
