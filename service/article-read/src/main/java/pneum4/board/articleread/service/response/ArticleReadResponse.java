package pneum4.board.articleread.service.response;
...
public class ArticleReadResponse {
    ...
    public static ArticleReadResponse from(ArticleQueryModel articleQueryModel, Long articeViewCount) {
        ...
        response.articleViewCount = articeViewCount;
        return response;
    }
}
