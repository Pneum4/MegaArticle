package pneum4.board.article.api;
...
public class ArticleApiTest {
    ...
    @Test
    void readTest() {
        ArticleResponse response = read(210373020029870080L);
        System.out.println("response = " + response);
    }
    ...
    void update(Long articleId) {
        restClient.put()
                .uri("/v1/articles/{articleId}", articleId)
                .body(new ArticleUpdateRequest("hello", "my content2"))
                .retrieve();
    }
    ...
    void deleteTest() {
        restClient.delete()
                .uri("/v1/articles/{articleId}", 210373020029870080L)
                .retrieve();
    }
