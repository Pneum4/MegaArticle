...
class HotArticleListRepositoryTest {
    ...
    void addTest() throws InterruptedException {
        // given
        LocalDateTime time = LocalDateTime.of(2022, 2, 22, 0, 0);
        long limit = 3;
        ...
        // then
        List<Long> articleIds = hotArticleListRepository.readAll("20220222");
        ...
        assertThat(hotArticleListRepository.readAll("20220222")).isEmpty();
    }
}